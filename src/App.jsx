...
return (
  <div className='container'>
    ...
    <div className="texto">
      <h2>Décimos !!!</h2>
      <p>Caso tenha dificuldades em digitar o <span>ponto final</span>, primeiro digite um número qualquer, depois disso, volte a seleção para <span>antes</span> do número e insira o <span>ponto final</span> antes dele, isso deve funcionar.</p> 
      <p>Isso acontece porque originalmente foi programado para usar a <span>vírgula</span>, porém alguns teclados só permitem o <span>ponto final</span>. Isso é apenas um problema temporário que deve ser arrumado em uma atualização futura.</p>
      <h2>Como Funciona?</h2>
    ...
    <footer>
      <div className="text-box">
        ...
        <p>O código da aplicação está <a href='https://github.com/MarcosG66/Calculadora-Media-Ari'>aqui</a>.</p>
        <p>Feedback dos usuários e sugestões de alteração são muito bem-vindas.</p>
      </div>
    </footer>
  </div>
);
